...
mongoose
  .connect(
    "mongodb+srv://prathiba2654:prathiba@cluster0.wzncipk.mongodb.net/",
    {
...
const sendVerificationEmail = async (email, verificationToken) => {
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "prathiba2654@gmail.com",
      pass: "sxoiogojuykhqvzn",
    },
  });
...
app.post("/like/:postId/:userId", async (req, res) => {
  try {
    ...
    //check if the user has already liked the post if yes remove the like
